...
def parse_args():
    ...
    #path
    parser.add_argument("--train_path", default=base_dir+"/data/SemEval2010_task8_all_data/SemEval2010_task8_training/TRAIN_FILE.TXT",
                        type=str, help="Path of train data")
    parser.add_argument("--test_path", default=base_dir+"/data/SemEval2010_task8_all_data/SemEval2010_task8_testing_keys/TEST_FILE_FULL.TXT",
    ...
    parser.add_argument("--x_vocab_path",
                        default=base_dir+'/data/dict/x_vocab.pkl',
                        type=str, help="path of save x_vocab")
    parser.add_argument("--pos_vocab_path",
                        default=base_dir+'/data/dict/pos_vocab.pkl',
                        type=str, help="path of save pos_vocab")

    #Data loading params
    parser.add_argument("--max_seq_len", default=89,
    ...
    parser.add_argument("--word_embedding_path", default=base_dir+"/data/pretrain/glove_embed_matrix.npy",
    ...
    # relation
    parser.add_argument("--num_relations", default=19,
