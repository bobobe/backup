...
class GSN(object):
    ...
    def add_placeholders(self):
        ...
        self.source_domain_labels = tf.placeholder(tf.int32, shape=[self.batch_size, 2], name="source_domain_labels")#数据属于的域
        self.target_domain_labels = tf.placeholder(tf.int32, shape=[self.batch_size, 2], name="target_domain_labels")  # 数据属于的域
